...
public class BillRestControllerImpl {
	...
	public String ajout_Bill_To_User(@PathVariable("id_user") int id_user, @PathVariable("id_kinder") int id_kinder,
	...
	public List<Bill> getAllBillForUserInKinder(@PathVariable("idkinder") int idkinder,
			@PathVariable("iduser") int usertId) {
	...
	@ResponseBody
	public long getNumberOfChildForUserInKinderJPQL(@PathVariable("iduser") int iduser,
